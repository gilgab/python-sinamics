...
def graph(inverter, param_array, graph_time=10000.0,
    ...
    - using save=true, you can save the graph as a file
      ...
      filepath='<Directory>/graph1.jpg'. Not all file types are accepted.
